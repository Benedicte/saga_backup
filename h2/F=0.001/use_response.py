...
F = 0.001 
w = np.array((2*np.pi,0.1))


### Polarization in X direction #####

pos_F_xx = np.load('0.001dir0.npy')[after_pulse:]
neg_F_xx =  np.load('-0.001dir0.npy')[after_pulse:]
pos_2F_xx =  np.load('0.002dir0.npy')[after_pulse:]
neg_2F_xx =  np.load('-0.002dir0.npy')[after_pulse:]


### Polarization in Z direction #####

pos_F_zz = np.load('0.001dir2.npy')[after_pulse:]
neg_F_zz =  np.load('-0.001dir2.npy')[after_pulse:]
pos_2F_zz =  np.load('0.002dir2.npy')[after_pulse:]
neg_2F_zz =  np.load('-0.002dir2.npy')[after_pulse:]


### Polarization in Y direction #####

pos_F_yy = np.load('0.001dir1.npy')[after_pulse:]
neg_F_yy =  np.load('-0.001dir1.npy')[after_pulse:]
pos_2F_yy =  np.load('0.002dir1.npy')[after_pulse:]
neg_2F_yy =  np.load('-0.002dir1.npy')[after_pulse:]
