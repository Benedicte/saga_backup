...
if(polarization_direction == 0):
    np.save("deg_" + rot_num +"/" + str(F_str) + magnetic_field_direction + "pol_y" + arr[polarization_direction] + ".npy",  dip_y)
    np.save("deg_" + rot_num +"/"+ str(F_str) + magnetic_field_direction + "pol_z" + arr[polarization_direction] + ".npy",  dip_z)


if(polarization_direction == 1):
    np.save("deg_" + rot_num +"/"+ str(F_str) + magnetic_field_direction + "pol_x" + arr[polarization_direction] + ".npy",  dip_x)
    np.save("deg_" + rot_num +"/"+str(F_str) + magnetic_field_direction + "pol_z" + arr[polarization_direction] + ".npy",  dip_z)
...
np.save("deg_" + rot_num +"/"+"time_points.npy", time_points)
