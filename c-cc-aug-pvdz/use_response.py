...
pos_F_xx = np.load('0.002dir0.npy')[after_pulse:]
neg_F_xx =  np.load('-0.002dir0.npy')[after_pulse:]
pos_2F_xx =  np.load('0.004dir0.npy')[after_pulse:]
neg_2F_xx =  np.load('-0.004dir0.npy')[after_pulse:]


### Polarization in Z direction #####

pos_F_zz = np.load('0.002dir2.npy')[after_pulse:]
neg_F_zz =  np.load('-0.002dir2.npy')[after_pulse:]
pos_2F_zz =  np.load('0.004dir2.npy')[after_pulse:]
neg_2F_zz =  np.load('-0.004dir2.npy')[after_pulse:]


### Polarization in Y direction #####

pos_F_yy = np.load('0.002dir1.npy')[after_pulse:]
neg_F_yy =  np.load('-0.002dir1.npy')[after_pulse:]
pos_2F_yy =  np.load('0.004dir1.npy')[after_pulse:]
neg_2F_yy =  np.load('-0.004dir1.npy')[after_pulse:]
