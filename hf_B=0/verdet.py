...
zy_lx = inst.extract_first_order(F, w, time_points, pos_Fx_zy, neg_Fx_zy, pos_2Fx_zy, neg_2Fx_zy)

xz_ly = inst.extract_first_order(F, w, time_points, pos_Fy_xz, neg_Fy_xz, pos_2Fy_xz, neg_2Fy_xz)
zx_ly = inst.extract_first_order(F, w, time_points, pos_Fy_zx, neg_Fy_zx, pos_2Fy_zx, neg_2Fy_zx)

xy_lz = inst.extract_first_order(F, w, time_points, pos_Fz_xy, neg_Fz_xy, pos_2Fz_xy, neg_2Fz_xy)
...
print("added the component")
print(delta_elec_pol_2)


#verdet_constant = (1/6)*delta_elec_pol.imag*calc_constant(omega)

#print("verdet_constant with constants")
